...
$cohortName = htmlspecialchars($data['cohort_name'], ENT_QUOTES, 'UTF-8');
...
<head>
    ...
    <title>Cohort Enrollment Confirmation</title>
</head>
    ...
    <tr>
        <td align="center">
            <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border:1px solid #e2e8f0;border-radius:12px;overflow:hidden;">
                <tr>
                    <td align="center" style="background:linear-gradient(135deg,#16a34a 0%,#15803d 100%);padding:28px 24px;">
                        <img src="<?= $logoUrl ?>" alt="Linkskool" width="160" style="display:block;">
                    </td>
                </tr>
                <tr>
                    <td style="padding:36px;">
                        <h2 style="margin:0 0 16px 0;font-size:28px;color:#0f172a;">Enrollment Confirmed</h2>
                        <p style="margin:0 0 12px 0;">Hello <strong><?= $studentName ?></strong>,</p>
                        <p style="margin:0 0 12px 0;">You have successfully enrolled in the cohort course below:</p>
                        <p style="margin:0 0 8px 0;"><strong>Program:</strong> <?= $programName ?></p>
                        <p style="margin:0 0 8px 0;"><strong>Course:</strong> <?= $courseName ?></p>
                        <p style="margin:0 0 22px 0;"><strong>Cohort:</strong> <?= $cohortName ?></p>
                        <p style="margin:0;">
                            <a href="<?= $appUrl ?>" style="display:inline-block;background:#16a34a;color:#ffffff;text-decoration:none;padding:12px 24px;border-radius:8px;font-weight:600;">Go to Dashboard</a>
                        </p>
