...
$planName = htmlspecialchars($data['plan_name'] ?? 'subscription', ENT_QUOTES, 'UTF-8');
            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border:1px solid #e2e8f0;border-radius:12px;overflow:hidden;">
                ...
                <tr>
                    <td style="padding:32px 28px;">
                        <h1 style="margin:0 0 8px 0;font-size:28px;font-weight:600;color:#0f172a;">Your checkout is still waiting</h1>
                        <p style="margin:0 0 24px 0;font-size:15px;color:#64748b;line-height:1.6;">
                            Hello <strong style="color:#0f172a;"><?= $recipientName ?></strong>, you started a payment for your Linkskool subscription but it was not completed.
                        </p>

                        <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:18px 20px;margin-bottom:24px;">
                            <p style="margin:0 0 8px 0;font-size:14px;color:#475569;"><strong style="color:#0f172a;">Plan:</strong> <?= $planName ?></p>
                        ...
                        <div style="background:#eff6ff;border-left:4px solid #2563eb;padding:18px 20px;border-radius:6px;margin-bottom:28px;">
                            <p style="margin:0;font-size:14px;color:#1e3a8a;line-height:1.7;">
                                You can return to Linkskool anytime to start a fresh checkout and continue your learning journey.
                            </p>
                        </div>
                ...
                $footerData = [
                    ...
                    'social_icon_size' => 24,
                    'footer_note' => 'You received this email because you started a checkout on Linkskool.',
                ];
