...
class Course extends QueryExecutor
{
    ...
    public function updateCourse(array $data, array $conditions)
    {
        return parent::update(table: $this->table, data: $data, conditions: $conditions);
    }

    /**
     * Retrieves course records from the database.
     *
     ...
     */
    public function getCourses(array $columns = [], array $conditions = [], int $limit = 0)
    {
