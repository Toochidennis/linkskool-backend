...
class Level extends QueryExecutor
{
    ...
    public function __construct(\PDO $pdo)
    {
        ...
        $this->table = 'level_table';
    }

    public function insertLevel(array $data)
    {
        return parent::insert(table: $this->table, data: $data);
    }

    public function updateLevel(array $data, array $conditions)
    {
        return parent::update(table: $this->table, data: $data, conditions: $conditions);
    }

    /**
     * Retrieves level records from the database.
     *
     ...
     */
    public function getLevels(array $columns = [], array $conditions = [], int $limit = 0)
    {
